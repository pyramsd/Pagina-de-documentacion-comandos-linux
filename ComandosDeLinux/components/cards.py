    ...
    return rx.vstack(
        rx.card(rx.vstack(
            ...
            rx.container(rx.blockquote("Mover archivos o directorios:", size="2"),
                         rx.code_block("""mv [archivo o diretorio] [ruta destino]""", language="bash", 
                                       width="100%", font_size="0.8em", theme="dark"), 
                                       rx.text("Tabién se usa para cambiar el nombre ",
                                               rx.code("mv [nombre] [nombre nuevo]"), color="white"), width="100%"),
        ...
        rx.card(rx.vstack(
            ...
            rx.container(rx.blockquote("Mostrar información sobre interfaces de red:", size="2"),
                         rx.code_block("""ifconfig""", language="bash", width="100%", font_size="0.8em", theme="dark"), 
                         rx.code_block("""ip""", language="bash", width="100%", font_size="0.8em", theme="dark"), width="100%"),
